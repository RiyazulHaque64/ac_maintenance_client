import type { IPost } from 'src/types/blog';
    ...
    <>
      <Card sx={{ display: 'flex', ...sx }} {...other}>
        <Stack spacing={1} flexGrow={1} sx={{ p: (theme) => theme.spacing(3, 3, 2, 3) }}>
          ...
          <Stack spacing={1} flexGrow={1}>
            <Link
              ...
              href={paths.dashboard.root} // paths.dashboard.post.details(post.title)
              color="inherit"
              variant="subtitle2"
              sx={{ ...maxLine({ line: 2 }) }}
            >
        ...
        >
          ...
          />
          <Image alt={post.title} src={post.thumbnail} sx={{ height: 1, borderRadius: 1.5 }} />
        </Box>
      </Card>
      ...
      >
        <MenuList>
          <MenuItem
            onClick={() => {
              popover.onClose();
              router.push(paths.dashboard.root); // paths.dashboard.post.details(post.title)
            }}
          >
          ...
          <MenuItem
            onClick={() => {
              popover.onClose();
              router.push(paths.dashboard.root); // paths.dashboard.post.edit(post.title)
            }}
          >
